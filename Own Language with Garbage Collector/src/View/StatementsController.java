...
public class StatementsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        IStmt repeatStmt = new CompStmt(new VarDeclStmt("v", new IntType()),
                new CompStmt(new VarDeclStmt("x", new IntType()),
                        new CompStmt(new VarDeclStmt("y", new IntType()),
                                new CompStmt(new repeat(new CompStmt(new ForkStmt(f), new AssignStmt("v", new ArithExp('+', new VarExp("v"), new ValueExp(new IntValue(1))))),
        ...
        programStatements = new ArrayList<>(Arrays.asList(ex1, ex2, ex10, ex4, ex5, repeatStmt));
        programStatementsListView.getItems().addAll(ex1.toString(), ex2.toString(), ex10.toString(), ex4.toString(), ex5.toString(), repeatStmt.toString());
    }
}
