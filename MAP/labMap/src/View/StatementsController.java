                ...
                new CompStmt(new VarDeclStmt("v", new IntType()),
                        new CompStmt(new AssignStmt("a", new ValueExp(new BoolValue(true))),
                                new CompStmt(new IfStmt(new VarExp("a"), new AssignStmt("v", new ValueExp(new
                                        ...
                                        VarExp("v"))))));
        programStatements = new ArrayList<>(Arrays.asList(ex1, ex2, ex10, ex4, ex5));
        programStatementsListView.getItems().addAll(ex1.toString(), ex2.toString(), ex10.toString(), ex4.toString(), ex5.toString());
    }
}
