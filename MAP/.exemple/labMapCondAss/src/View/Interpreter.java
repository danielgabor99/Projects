...
public class Interpreter {
    public static void main(String[] args) throws FileNotFoundException, MyException {
        ...
        MyIStack<IStmt> ExeStackcond = new MyStack<IStmt>();
        MyIDictionary<String, Value> symTablecond = new MyDictionary<String, Value>();
        MyIList<Value> outcond = new MyList<Value>();
        MyIDictionary<String, BufferedReader> fileTablecond = new FileTable<String, BufferedReader>();
        MyIHeap<Integer, Value> hpcond = new MyHeap<Integer, Value>();

        IStmt excond = new CompStmt(new VarDeclStmt("b", new BoolType()),
                new CompStmt(new VarDeclStmt("c", new IntType()),
                        new CompStmt(new AssignStmt("b", new ValueExp(new BoolValue(true))),
                                new CompStmt(new CondAssign("c", new VarExp("b"), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(100))),
...
/**
 PrgState prgcond = new PrgState(ExeStackcond, symTablecond, outcond, fileTablecond, hpcond, excond);
 RepositoryI repocond = new Repository(prgcond, "textcond.txt");
 Controller ctrcond = new Controller(repocond);
 ...
 menu.addCommand(new RunExample("11", excond.toString(), ctrcond));
 menu.show();
 */
