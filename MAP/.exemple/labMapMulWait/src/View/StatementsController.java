                ...
                new CompStmt(new VarDeclStmt("v", new IntType()),
                        new CompStmt(new AssignStmt("a", new ValueExp(new BoolValue(true))),
                                new CompStmt(new IfStmt(new VarExp("a"), new AssignStmt("v", new ValueExp(new
                                        ...
                                        VarExp("v"))))));
        IStmt wait = new CompStmt(new VarDeclStmt("v", new IntType()),
                new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(20))),
                        new CompStmt(new wait(10), new PrintStmt(new ArithExp('*', new VarExp("v"), new ValueExp(new IntValue(10)))))));

        IStmt Mul = new CompStmt(new VarDeclStmt("v1", new IntType()),
                new CompStmt(new AssignStmt("v1", new ValueExp(new IntValue(2))),
                        new CompStmt(new VarDeclStmt("v2", new IntType()),
                                new CompStmt(new AssignStmt("v2", new ValueExp(new IntValue(3))),
                                        new IfStmt(new RelExp(new VarExp("v1"), new ValueExp(new IntValue(0)), "!="), new PrintStmt(new Mul(new VarExp("v1"), new VarExp("v2"))), new PrintStmt(new VarExp("v1")))))));
        programStatements = new ArrayList<>(Arrays.asList(ex1, ex2, ex10, ex4, ex5, wait, Mul));
        programStatementsListView.getItems().addAll(ex1.toString(), ex2.toString(), ex10.toString(), ex4.toString(), ex5.toString(), wait.toString(), Mul.toString());
    }
}
