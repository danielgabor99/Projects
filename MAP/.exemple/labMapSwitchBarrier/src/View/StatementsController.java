...
public class StatementsController implements Initializable {
    ...
    public void buildstatements() {
        ...
        IBarrier<Integer, Pair<Integer, List<Integer>>> bar = new Barrier<>();
        ...
        executeProgram.setOnAction(actionEvent -> {
            ...
            if (index < 0)
                return;
            PrgState initialPrgState = new PrgState(ExeStack1, symTable1, out1, fileTable1, hp1, programStatements.get(index), bar);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
                ...
                new CompStmt(new VarDeclStmt("v", new IntType()),
                        new CompStmt(new AssignStmt("a", new ValueExp(new BoolValue(true))),
                                new CompStmt(new IfStmt(new VarExp("a"), new AssignStmt("v", new ValueExp(new
                                        ...
                                        VarExp("v"))))));
        IStmt Switch = new CompStmt(new VarDeclStmt("a", new IntType()),
        ...
        programStatements = new ArrayList<>(Arrays.asList(ex1, ex2, ex10, ex4, ex5, Switch, Bar));
        programStatementsListView.getItems().addAll(ex1.toString(), ex2.toString(), ex10.toString(), ex4.toString(), ex5.toString(), Switch.toString(), Bar.toString());
    }
}
