...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private TableView<Map.Entry<Integer, List<Integer>>> barrierTableView;
    @FXML
    ...
    public void populateBarierTable(PrgState currentPrgState) {
        IBarrier<Integer, Pair<Integer, List<Integer>>> barrier = currentPrgState.getBarrier();

        //List<Map.Entry<Integer,List<Integer>>> heapTableList= new ArrayList<Integer,List<Integer>>(barrier.getContent().entrySet());
        //barrierTableView.setItems(FXCollections.observableList(heapTableList));
